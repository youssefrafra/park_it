...
parking1 = Parking.new(title:"Un titre" ,address: "34 Rue des Bouchers, Lille, Hauts-de-France, France", description: "Garage situé en sous-sol",start_date: Date.new(2021,06,23), end_date: Date.new(2021,06,25), from_hour: Time.now, to_hour: Time.now, available: true)
parking2 = Parking.new(title:"Un titre" ,address: "15 Rue du Congo, Mouvaux, Hauts-de-France, France", description: "Garage extérieur avec porte automatique", start_date: Date.new(2021,07,02), end_date: Date.new(2021,07,05), from_hour: Time.now, to_hour: Time.now, available: true)
parking3 = Parking.new(title:"Un titre" ,address: "56 Rue de la Barre, Lille, Hauts-de-France, France", description: "Box pour 2 motos", start_date: Date.new(2021,01,01), end_date: Date.new(2021,01,20), from_hour: Time.now, to_hour: Time.now, available: true)
parking4 = Parking.new(title:"Un titre" ,address: "465 Littoral Frédéric Mistral, Toulon, Provence-Alpes-Côte d'Azur, France", description: "Local à vélos", start_date: Date.new(2021,03,16), end_date: Date.new(2021,03,17), from_hour: Time.now, to_hour: Time.now, available: true)
